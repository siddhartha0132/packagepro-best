...
export default function Home() {
  ...
  const loading = createTrip.isPending || selectFlight.isPending || selectHotel.isPending || swap.isPending || continuePackage.isPending || selectGuide.isPending || skipGuide.isPending || negotiate.isPending || goBack.isPending || confirm.isPending;
