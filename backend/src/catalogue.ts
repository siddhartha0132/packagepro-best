...
// Read-only access to the PS-04 hackathon dataset (data-model/seed/PS-04.db).
// Money columns are TEXT on purpose (rule R3): convert through paise integers, never parseFloat arithmetic.

export const DATASET_PATH = process.env.PACKAGEPRO_DB || path.resolve(process.cwd(), "data-model/seed/PS-04.db");
