...
const IMAGE_CACHE_FILE = path.resolve(process.cwd(), "data/city-images.json");
...
/** Resolve destination photos (Wikipedia REST, no key). Resolved URLs are kept in data/city-images.json so a fresh deploy never starts with blank cards. */
